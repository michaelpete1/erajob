    ...
    <div class="relative z-10 w-full max-w-md mx-auto px-4 py-6">
      ...
      <div class="mx-auto w-full max-w-md px-4 py-6 animate-fade-up-delay-2">
        <div class="mb-4 animate-slide-in-left">
          <div class="relative">
            <input type="text" placeholder="Search" class="w-full rounded-full border border-white/30 bg-white/10 px-5 py-2.5 pr-10 text-sm text-white placeholder-white/70 focus:outline-none focus:ring-2 focus:ring-white focus:border-white transition-all" />
        ...
        <div class="px-2 py-6 space-y-3 animate-fade-up-delay-4">
          <router-link to="/client/add-post" class="btn-pressable block w-full rounded-full bg-brand-teal px-6 py-3 text-center text-sm font-semibold text-white shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300">
            Next
          </router-link>
