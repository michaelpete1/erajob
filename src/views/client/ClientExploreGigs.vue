<template>
  <div class="relative min-h-screen bg-gradient-to-br from-brand-teal via-teal-600 to-teal-700 flex items-center justify-center overflow-hidden">
    ...
    <div class="relative z-10 w-full max-w-md mx-auto px-4 py-6">
      ...
      <h2 class="text-2xl md:text-3xl font-extrabold text-brand-teal mb-2 animate-fade-up-delay-1">Explore Gigs</h2>
      <p class="text-base md:text-lg font-semibold text-brand-teal mb-4 animate-fade-up-delay-2">Discover exciting opportunities</p>
      <div class="mx-auto mt-2 max-w-sm text-left space-y-3 text-gray-700 animate-fade-up-delay-3">
        <p>Browse through available gigs and find the perfect match for your skills and interests.</p>
        ...
        <p>Start your journey with ERA today!</p>
      </div>

      <router-link to="/client/gigs-listing" class="btn-pressable mt-10 inline-flex items-center justify-center rounded-full bg-brand-teal px-8 py-3 text-sm font-semibold text-white shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 animate-fade-up-delay-4">
        Explore Gigs
      </router-link>
      </div>
    </div>
