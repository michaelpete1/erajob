...
<template>
  ...
  <div class="relative content-front w-full max-w-xs sm:max-w-sm md:max-w-2xl mx-auto flex flex-col items-center justify-center text-center py-16 pb-8 md:pb-12">
      ...
      <p class="text-2xl md:text-3xl font-extrabold text-white mb-10 animate-fade-up-delay-3 bg-gradient-to-r from-white to-teal-100 bg-clip-text text-transparent">EBA onboarding</p>
      <router-link
